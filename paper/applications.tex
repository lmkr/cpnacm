...
generations of software tools: Design/CPN \cite{tacas97} and
...
Design/CPN and CPN Tools work directly on the high-level
...
version of Design/CPN supported modeling, syntax checking, and interactive
simulation. The introduction of hierarchical CPNs supported by the
Design/CPN tool had a dramatic impact to the practical use of Petri
...
appeared on top of a transition and gives the operations that can be
