...
transition nets with \concept{colored tokens} by M. Schiffers and
H. Wedde \cite{X} and transition nets with \concept{complex
  conditions} \cite{Y} by Robert Shapiro. The basic idea behind PrT
