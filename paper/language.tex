...
place \figitem{Waiting}. The if-then-else expression on the arc from
...
of a \concept{global model clock} that represents the current model
time and on attaching \concept{time stamps} to tokens in addition to
