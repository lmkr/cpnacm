...
model of a distributed two-phase commit transaction system.\rdc{\footnote{The full details of the CPN model presented in this paper are available via \texttt{http://goo.gl/HY4ZNQ}}}  The reader
...
composed of four \concept{modules} hierarchically organized into
...
respectively.\rdc{The name of the submodule is written in the rectangular
